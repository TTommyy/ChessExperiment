...
# Set variables
RESOURCE_GROUP="ChessAppResourceGroup"
APP_SERVICE_PLAN="ChessAppServicePlan"
FRONTEND_APP="chess-research-pragma-frontend"
BACKEND_URL="https://chess-research-pragma-backend.azurewebsites.net"
LOCATION="eastus"
...
cd /Users/tomaszkoczar/Desktop/Studia/Chessv2/frontend
...
{
  "name": "chess-research-pragma-frontend",
  "version": "0.1.0",
  "private": true,
  "dependencies": {
    "axios": "^1.7.0",
