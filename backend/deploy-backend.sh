...
BACKEND_APP="chess-research-pragma-backend"
FRONTEND_URL="https://chess-research-pragma-frontend.azurewebsites.net"
...
cd /Users/tomaszkoczar/Desktop/Studia/Chessv2/backend
